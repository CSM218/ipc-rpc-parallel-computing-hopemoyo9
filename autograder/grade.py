    ...
    def run_tests(self, filter_suite=None, filter_type=None):
        ...
        for suite_name, tester in test_suites:
            ...
            for test_name, test_result in results.items():
                is_static = test_result.get("type") == "static" or \
                           "compilation" in test_name or "schema" in test_name or \
                           "socket" in test_name or "rpc" in test_name or \
                           "framework" in test_name or "variable" in test_name or \
                           "support" in test_name or "collection" in test_name or \
                           "format" in test_name or "serialization" in test_name
